...
from src.infra.routes.DocentesRoutes import blueprint as blueDocente
from src.infra.routes.MateriasRoutes import blueprint as blueMateria
from src.infra.routes.MatriculasRoutes import blueprint as blueMatricula
